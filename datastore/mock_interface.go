...
func (m *MockBook) CheckExistence(ctx context.Context, id int) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckExistence", ctx, id)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBookMockRecorder) CheckExistence(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckExistence", reflect.TypeOf((*MockBook)(nil).CheckExistence), ctx, id)
}
...
func (m *MockBook) GetAllBook(ctx context.Context) ([]entities.Books, error) {
	m.ctrl.T.Helper()
...
func (m *MockBook) GetBookByTitle(ctx context.Context, title string) ([]entities.Books, error) {
	m.ctrl.T.Helper()
...
// CheckExistence mocks base method.
func (m *MockAuthor) CheckExistence(ctx context.Context, id int) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckExistence", ctx, id)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
...
// CheckExistence indicates an expected call of CheckExistence.
func (mr *MockAuthorMockRecorder) CheckExistence(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckExistence", reflect.TypeOf((*MockAuthor)(nil).CheckExistence), ctx, id)
}
...
// FetchingAuthor mocks base method.
func (m *MockAuthor) FetchingAuthor(ctx context.Context, id int) (int, entities.Author) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchingAuthor", ctx, id)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(entities.Author)
	return ret0, ret1
}

// FetchingAuthor indicates an expected call of FetchingAuthor.
func (mr *MockAuthorMockRecorder) FetchingAuthor(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchingAuthor", reflect.TypeOf((*MockAuthor)(nil).FetchingAuthor), ctx, id)
}
